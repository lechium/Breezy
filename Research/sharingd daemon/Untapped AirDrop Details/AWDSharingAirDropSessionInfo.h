...
- (void).cxx_destruct;	// IMP=0x000000010008fa44
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010008f748
- (unsigned long long)hash;	// IMP=0x000000010008f550
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008f2b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008f06c
- (void)copyTo:(id)arg1;	// IMP=0x000000010008ee6c
- (void)writeTo:(id)arg1;	// IMP=0x000000010008ec9c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008ec94
- (id)dictionaryRepresentation;	// IMP=0x000000010008e040
- (id)description;	// IMP=0x000000010008df8c
