...
- (void).cxx_destruct;	// IMP=0x0000000100130204
- (_Bool)alwaysShowSetupRetry;	// IMP=0x000000010012ffc8
- (id)testDeviceID;	// IMP=0x000000010012ffac
- (_Bool)ignoreBackOff;	// IMP=0x000000010012ff84
- (_Bool)suggestionsEnabled;	// IMP=0x000000010012ff5c
- (void)setRetriedSetup;	// IMP=0x000000010012ff08
- (_Bool)retriedSetup;	// IMP=0x000000010012fe10
- (void)loadSuggestedPeers;	// IMP=0x000000010012fd2c
- (void)setFeatureSuggestedForDeviceID:(id)arg1;	// IMP=0x000000010012fb78
- (_Bool)featureSuggestedForDeviceID:(id)arg1;	// IMP=0x000000010012fafc
- (void)updateDefaultsForDeviceID:(id)arg1;	// IMP=0x000000010012f750
- (_Bool)canSuggestForDeviceID:(id)arg1;	// IMP=0x000000010012f4e8
- (_Bool)shouldSendRequestsForDeviceID:(id)arg1;	// IMP=0x000000010012f39c
- (void)watchAvailableForUnlockWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010012f38c
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x000000010012f00c
- (void)sendStartAdvertisingToDeviceID:(id)arg1;	// IMP=0x000000010012edcc
- (void)invalidateScanTimer;	// IMP=0x000000010012ecf4
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x000000010012eb08
- (void)invalidateScanner;	// IMP=0x000000010012e9c4
- (void)handleFoundPeer:(id)arg1;	// IMP=0x000000010012e5a4
- (void)startScanningForIDSDeviceIDs:(id)arg1;	// IMP=0x000000010012dd48
- (void)invalidateServiceTimer;	// IMP=0x000000010012dc70
- (void)restartServiceTimer:(unsigned long long)arg1;	// IMP=0x000000010012da6c
- (void)invalidateSuggestionService;	// IMP=0x000000010012da08
- (void)updateSuggestionService;	// IMP=0x000000010012d998
- (void)invalidateSuggestedDeviceTimer;	// IMP=0x000000010012d8c0
- (void)restartSuggestedDeviceTimer:(long long)arg1;	// IMP=0x000000010012d698
- (void)postSuggestionNotification;	// IMP=0x000000010012d500
- (void)postNotificationIfNeeded;	// IMP=0x000000010012d30c
- (void)invalidateSetupRetryDeviceTimer;	// IMP=0x000000010012d234
- (void)restartSetupRetryDeviceTimer:(long long)arg1;	// IMP=0x000000010012d00c
- (void)setupRetryNotificationDismissed;	// IMP=0x000000010012cf14
- (void)setupRetryNotificationSetUpSelected;	// IMP=0x000000010012cf10
- (void)setupRetryIfNeeded;	// IMP=0x000000010012cccc
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x000000010012cc08
- (void)triggerDevicesIfNeeded;	// IMP=0x000000010012cc04
- (void)handleTestSuggestion;	// IMP=0x000000010012cb0c
- (void)addObservers;	// IMP=0x000000010012cb08
- (id)init;	// IMP=0x000000010012c9c4
