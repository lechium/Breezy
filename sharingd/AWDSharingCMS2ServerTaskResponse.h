...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000a3350
- (unsigned long long)hash;	// IMP=0x00000001000a3274
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000a3120
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000a3008
- (void)copyTo:(id)arg1;	// IMP=0x00000001000a2f14
- (void)writeTo:(id)arg1;	// IMP=0x00000001000a2e24
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000a2e1c
- (id)dictionaryRepresentation;	// IMP=0x00000001000a26ec
- (id)description;	// IMP=0x00000001000a2638
