...
- (void).cxx_destruct;	// IMP=0x000000010003a5e8
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010003a098
- (unsigned long long)hash;	// IMP=0x0000000100039cd4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100039858
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010003945c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000390a4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100038d44
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100038d3c
- (id)dictionaryRepresentation;	// IMP=0x0000000100037468
- (id)description;	// IMP=0x00000001000373b4
