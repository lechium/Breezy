...
- (void)alertManager:(id)arg1 acceptingTransferWithRecordID:(NSString *)arg2 withDestinationURL:(NSURL *)arg3 shouldExtractImagesFromLivePhotosForRecordID:(_Bool)arg4;
@end
